"use strict";function render(e){var t=$(".table");for(var r in e){var a=$("<tr>",{class:"table__row"}),i={flightNum:e[r].thread.number,direction:e[r].departure,route:e[r].thread.title,company:e[r].thread.carrier.title,time:e[r].departure,delay:e[r].is_fuzzy};for(var l in t.append(a),i){var d=$("<td>",{class:"table__col"});switch(null!==e[r].departure?i.time=e[r].departure.split("T")[0]:null===i.direction?i.direction=e[r].arrival:null===i.time&&(i.time=e[r].arrival.split("T")[0]),i[l]===i.route&&d.addClass("table__col_font"),i[l]){case!0:d.addClass("table__col_color").text("Задержан");break;case!1:d.text("Ожидается в ".concat(i.direction));break;default:d.text(i[l])}i.direction=i.direction.split("T").pop().replace(/:\d+\+\d+:\d+/g,""),a.append(d)}}}function renderDelay(e){var t=$(".table");for(var r in e)if(e[r].is_fuzzy){var a=$("<tr>",{class:"table__row"}),i={flightNum:e[r].thread.number,direction:e[r].departure,route:e[r].thread.title,company:e[r].thread.carrier.title,time:e[r].departure,delay:e[r].is_fuzzy};for(var l in t.append(a),i){var d=$("<td>",{class:"table__col"});switch(null!==e[r].departure?i.time=e[r].departure.split("T")[0]:null===i.direction?i.direction=e[r].arrival:null===i.time&&(i.time=e[r].arrival.split("T")[0]),i[l]===i.route&&d.addClass("table__col_font"),i[l]){case!0:d.addClass("table__col_color").text("Задержан");break;case!1:d.text("Ожидается в ".concat(i.direction));break;default:d.text(i[l])}i.direction=i.direction.split("T").pop().replace(/:\d+\+\d+:\d+/g,""),a.append(d)}}}
